  ...
  return (
    <div className="bg-white pt-36 relative z-10" id="how-it-works">
      ...
      <motion.h2
        ...
        className="text-center text-secondary text-2xl md:text-3xl lg:text-4xl font-semibold pt-5"
      >
        How It Works
      </motion.h2>
      ...
      <motion.p
        ...
        viewport={{ once: true, amount: 0.3 }}
        className="text-center text-text px-4 md:px-12 lg:px-48 text-sm md:text-lg lg:text-xl pt-4"
      >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Image
          src="/images/biggrad.png"
          alt="decorator"
          width={150}
          height={150}
          className=" bottom-0 right-0 w-[200px] md:w-[400px] lg:w-[900px] object-contain -z-10 mx-auto mt-[100%] md:mt-[0%]"
        />
        <Image
          ...
          width={96}
          height={96}
          className="absolute top-7 left-6 -z-10 w-[45px] h-[45px]  md:w-[96px] md:h-[96px]"
        />
        <Image
          ...
          width={96}
          height={96}
          className="absolute top-7 right-6 -z-10  w-[45px] h-[45px]  md:w-[96px] md:h-[96px]"
        />
        <Image
          ...
          width={96}
          height={96}
          className="absolute bottom-7 right-6 -z-10 w-[45px] h-[45px]  md:w-[96px] md:h-[96px]"
        />
      </div>
    </div>
  );
